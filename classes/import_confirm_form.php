 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tool_uploadpageresults_import_confirm_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'columnsheader', get_string('columnsheader', 'tool_uploadpageresults'));
        ...
        $this->add_action_buttons(true, get_string('confirm', 'tool_uploadpageresults'));
    }
}
