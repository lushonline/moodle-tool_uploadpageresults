 ...
 *
 */
class tool_uploadpageresults_importer_testcase extends advanced_testcase {
    ...
    public function test_invalid_user() {
        ...
        $importer = new tool_uploadpageresults_importer(null, null, null, $importid, null);
        $results = $importer->execute(new tool_uploadpageresults_tracker(tool_uploadpageresults_tracker::OUTPUT_PLAIN, false));
