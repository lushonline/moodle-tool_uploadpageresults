@tool @tool_uploadpageresults @_file_upload
Feature: An admin can update a single page activity course using a CSV file
  ...
  Scenario: Update of course viewed and enrol user successful
    ...
    And I upload "admin/tool/uploadpageresults/tests/fixtures/onecourseresult.csv" file to "CSV file" filemanager
    And I press "Import"
    And I press "Confirm"
  ...
  Scenario: Update of course viewed and enrol user skipped as user does not exist
    Given I log in as "admin"
    And I navigate to "Courses > Upload page activities completions" in site administration
    And I upload "admin/tool/uploadpageresults/tests/fixtures/onecourseresult_nouser.csv" file to "CSV file" filemanager
    And I press "Import"
    And I press "Confirm"
  ...
  Scenario: Update of course viewed and enrol user skipped as user does not exist
    Given I log in as "admin"
    And I navigate to "Courses > Upload page activities completions" in site administration
    And I upload "admin/tool/uploadpageresults/tests/fixtures/onecourseresult_nocourse.csv" file to "CSV file" filemanager
    And I press "Import"
    And I press "Confirm"
